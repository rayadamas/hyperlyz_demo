...
// (function(){
	...
	var demo = new Demo({
      ...
      soundSamples:{
        ...
        values: [
          ["if-right-or-wrong", "song-thrush-rspb"],
          ["renacido","transient-orca"],
          ["As-I-Should-Be","police-siren"],
          ["Tear-Me-Down-Demo","modem"],
          ["Different-world-Zora","violin"],
          ["they-dont-know","whistle"],
          ["PNTHR","sad-trombone"]
